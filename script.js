...
if(formContainer) {
    ...
    const formSteps = {
        ...
        'create-banner': { question: "Choose a design package for your socials:", type: 'package-selection', packages: [ { title: 'Weekly Content Kit', benefit: 'Stop the Scroll with an Eye-Catching Design.', features: ['4 High-Impact Posts', '1 Reel / Motion Graphic', 'Caption & Hashtag Strategy'], timeline: '5-7 Days', price: '₹2,500 – ₹4,500' }, { title: 'Ad & Banner Campaign', benefit: "High-conversion graphics for your ads and launches", features: ['5 Banners for Different Platforms', 'Multiple Size Formats', '3 Rounds of Revisions'], timeline: '4 Days', price: '₹2,500 – ₹6,000', popular: true, glow: 'hyper-glow-purple' }, { title: 'Custom Graphics', benefit: "Unique visuals tailored to your campaign.", features: ['Video Thumbnails', 'Ad Creatives', 'Animated Graphics'], timeline: 'Project-Based', price: 'Based on Needs', custom: true } ] },
