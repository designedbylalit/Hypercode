...
if(formContainer) {
    ...
    const formSteps = {
        ...
        'build-website': { question: "Choose the best path for your business:", type: 'package-selection', packages: [ { title: 'Starter Site', benefit: 'Get Online Fast and Look Professional.', features: ['1-Page Website', 'Mobile-Friendly Design', 'WhatsApp/Contact Form'], timeline: '3-5 Days', price: '₹3,000 – ₹7,000' }, { title: 'Growth-Ready Site', benefit: 'Tell Your Full Story and Impress Visitors.', features: ['Multi-Section Page', 'Basic Animations', 'SEO-Friendly Structure'], timeline: '7-10 Days', price: '₹9,000 – ₹15,000' }, { title: 'Business Website', popular: true, glow: 'hyper-glow-purple', benefit: 'Attract More Customers and Rank on Google.', features: ['3-5 Pages', 'Advanced SEO & Speed', 'Easy-Update Admin Panel'], timeline: '15-20 Days', price: '₹18,000 – ₹30,000' }, { title: 'Premium Website', glow: 'hyper-glow-blue', benefit: 'Become a Market Leader with a World-Class Experience.', features: ['5+ Pages', 'Elite UI/UX', 'CMS Integration'], timeline: '~1 Month', price: 'Starting at ₹35,000+' } ] },
        'boost-speed': { question: "Select a performance solution:", type: 'package-selection', packages: [ { title: 'Performance Audit', benefit: 'Discover Exactly Why Your Site is Slow.', features: ['Detailed Performance Report', 'Actionable Recommendations', 'Clear "Next Steps" Guide'], timeline: '3 Days', price: '₹3,000 – ₹5,000' }, { title: 'Audit & Implementation', benefit: "Stop Losing Visitors to a Slow Website.", features: ['Full Audit & Fixes', 'Image & Asset Optimization', 'Before & After Report'], timeline: '10 Days', price: 'Starting at ₹10,000+', popular: true, glow: 'hyper-glow-purple' }, { title: 'Custom Solution', benefit: "Have a unique performance challenge? Let's talk.", features: ['Bespoke Optimization', 'Ongoing Support', 'Dedicated Consultation'], timeline: 'Project-Based', price: 'Based on Needs', custom: true } ] },
        'design-ui': { question: "Choose a design package:", type: 'package-selection', packages: [ { title: 'Landing Page UI', benefit: 'Capture Attention with a Stunning First Impression.', features: ['High-Fidelity Figma Design', 'Component Breakdown', 'Style Guide (Colors & Fonts)'], timeline: '7 Days', price: '₹7,000 – ₹12,000' }, { title: 'Multi-Screen App/Site UI', benefit: "Give Your Users an Experience They'll Love.", features: ['Up to 5 Core Screens', 'Interactive Prototype', 'Mobile & Desktop Views'], timeline: '15-20 Days', price: '₹25,000 – ₹50,000', popular: true, glow: 'hyper-glow-purple' }, { title: 'Complete UX/UI System', benefit: "A Deep Dive into User-Centric Design.", features: ['User Research', 'Wireframes', 'Full Design System'], timeline: '1+ Month', price: 'Starting at ₹70,000+', glow: 'hyper-glow-blue' } ] },
        'create-logo': { question: "Select your brand identity solution:", type: 'package-selection', packages: [ { title: 'Logo Essentials', benefit: 'Get a Unique, Memorable Logo for Your Brand.', features: ['2 Initial Concepts', '3 Rounds of Revisions', 'All Essential Files (PNG, SVG)'], timeline: '3-5 Days', price: '₹700 – ₹1,500' }, { title: 'Brand Identity Kit', benefit: "Build a Complete and Consistent Brand Image.", features: ['3 Premium Concepts', 'Full Brand Guide', 'Social Media Profile Pictures'], timeline: '7-10 Days', price: '₹5,000 – ₹10,000', popular: true, glow: 'hyper-glow-purple' }, { title: 'Custom Branding', benefit: "Need more than a logo? Let's craft your full story.", features: ['Full Brand Strategy', 'Custom Illustrations', 'Packaging Design'], timeline: 'Project-Based', price: 'Based on Scope', custom: true } ] },
        'create-banner': { question: "Choose a design package for your socials:", type: 'package-selection', packages: [ { title: 'Single Design', benefit: 'Stop the Scroll with an Eye-Catching Design.', features: ['1 Social Media Graphic', '2 Rounds of Revisions', 'Source File Included'], timeline: '2 Days', price: '₹500 – ₹1,500' }, { title: 'Social Media Pack', benefit: "Your Social Media Content, Sorted for the Week.", features: ['5 Banners for Different Platforms', 'Multiple Size Formats', '3 Rounds of Revisions'], timeline: '4 Days', price: '₹2,500 – ₹6,000', popular: true, glow: 'hyper-glow-purple' }, { title: 'Custom Graphics', benefit: "Unique visuals tailored to your campaign.", features: ['Video Thumbnails', 'Ad Creatives', 'Animated Graphics'], timeline: 'Project-Based', price: 'Based on Needs', custom: true } ] },
